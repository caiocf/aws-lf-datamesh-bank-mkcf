...
# Lê silver (particionado por pais — basePath detecta Hive partitions)
...
# Gold = apenas parceiros ativos
df_gold = df.filter(F.col("contrato_status") == "ativo")

print(f"Gold: {df_gold.count()} parceiros ativos")
